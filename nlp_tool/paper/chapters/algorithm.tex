...
(\textbf{ea}sy) which is mapped to ``i'' (\textbf{i}si) in Filipino. In
addition, long vowel spellings such as ``ee'' and ``oo'' are generally
shortened, with ``ee'' mapping to ``i'' and ``oo'' to ``u''.
