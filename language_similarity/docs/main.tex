...
\author{
  \textbf{Roan Ceric Campo} \quad
  \textbf{Clive Jarel Ang} \quad
  \textbf{Clarence Ivan Ang} \quad
  \textbf{Zhean Robby Ganituen} \\
...
\input{chapters/4-results_and_discussion.tex}
...
\input{chapters/6-limitations.tex}
\input{chapters/7-ethics_statement.tex}
